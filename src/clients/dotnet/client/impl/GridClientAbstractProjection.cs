...
namespace GridGain.Client.Impl {
    ...
    internal abstract class GridClientAbstractProjection<T> where T : GridClientAbstractProjection<T> {
         ...
         * <exception cref="GridClientServerUnreachableException">
         * If either none of the server can be reached or each attempt of communication within <see cref="RetryCount"/>
         * attempts resulted in <see cref="GridClientConnectionResetException"/></exception>
         */
        protected TRes WithReconnectHandling<TRes>(Func<IGridClientConnection, TRes> c) {
            N node = null;
         ...
         * <returns>Closure result.</returns>
         * <exception cref="GridClientClosedException">If client was closed manually.</exception>
         * <exception cref="GridClientServerUnreachableException">If none of the nodes can be reached.</exception>
         */
        protected TRes WithReconnectHandling<TRes>(Func<IGridClientConnection, TRes> c, String cacheName, Object affKey) {
            ...
            N node = affinity.Node(affKey, ProjectionNodes());
            ...
            foreach (N node in top.Nodes()) {
                try {
                    ...
                    try {
                        ...
                        N target = conn.Node(nodeId, false, false).Result;
