...
namespace GridGain.Client.Impl {
    ...
    internal sealed class GridClientImpl : IGridClient, IGridClientProjectionConfig {
        ...
        public void stop(bool waitCompletion) {
            ...
            //Dbg.WriteLine("Join thread: " + topUpdateThread.Name);
            //Dbg.WriteLine("Join thread: " + idleCheckThread.Name);
            ...
            //Dbg.WriteLine("Thread stopped: " + topUpdateThread.Name);
            //Dbg.WriteLine("Thread stopped: " + idleCheckThread.Name);
