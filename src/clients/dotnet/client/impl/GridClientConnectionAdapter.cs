...
namespace GridGain.Client.Impl {
    ...
    internal abstract class GridClientConnectionAdapter : IGridClientConnection {
         ...
         */
        public IGridClientFuture<Boolean> CachePut<TKey, TVal>(String cacheName, TKey key, TVal val) {
            IDictionary<TKey, TVal> map = new Dictionary<TKey, TVal>();

            map.Add(key, val);

            return CachePutAll<TKey, TVal>(cacheName, map);
        }
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public virtual IGridClientFuture<TVal> CacheGet<TKey, TVal>(String cacheName, TKey key) {
            IGridClientFuture<IDictionary<TKey, TVal>> res = CacheGetAll<TKey, TVal>(cacheName, new TKey[] { key });
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<Boolean> CacheRemove<T>(String cacheName, T key);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<Boolean> CachePutAll<TKey, TVal>(String cacheName, IDictionary<TKey, TVal> entries);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IDictionary<TKey, TVal>> CacheGetAll<TKey, TVal>(String cacheName, IEnumerable<TKey> keys);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture CacheRemoveAll<TKey>(String cacheName, IEnumerable<TKey> keys);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<Boolean> CacheAdd<TKey, TVal>(String cacheName, TKey key, TVal val);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<Boolean> CacheReplace<TKey, TVal>(String cacheName, TKey key, TVal val);
        /**
         * <summary>
         * </summary>
         * <param name="cacheName">Cache name.</param>
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<Boolean> CacheCompareAndSet<TKey, TVal>(String cacheName, TKey key, TVal val1, TVal val2);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IGridClientDataMetrics> CacheMetrics<TKey>(String cacheName, TKey key);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<T> Execute<T>(String taskName, Object taskArg);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IGridClientNode> Node(Guid id, bool includeAttrs, bool includeMetrics);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IGridClientNode> Node(String ipAddr, bool includeAttrs, bool includeMetrics);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IList<IGridClientNode>> Topology(bool includeAttrs, bool includeMetrics);
         ...
         * <exception cref="GridClientClosedException">If client was manually closed before request was sent over network.</exception>
         */
        public abstract IGridClientFuture<IList<String>> Log(String path, int fromLine, int toLine);
