...
public class GridCacheConfigurationAdapter implements GridCacheConfiguration {
    ...
    /** Synchronous eviction timeout. */
    private int evictSyncTimeout = DFLT_EVICT_SYNCHRONOUS_TIMEOUT;
    ...
    public GridCacheConfigurationAdapter(GridCacheConfiguration cc) {
        ...
        evictSyncConcurrencyLvl = cc.getEvictSynchronousConcurrencyLevel();
        evictSyncTimeout = cc.getEvictSynchronousTimeout();
    ...
    /** {@inheritDoc} */
    public int getEvictSynchronousConcurrencyLevel() {
     ...
     *
     * @param evictSyncConcurrencyLevel Synchronous eviction concurrency level.
     */
    public void setEvictSyncConcurrencyLevel(int evictSyncConcurrencyLevel) {
        this.evictSyncConcurrencyLvl = evictSyncConcurrencyLevel;
    }

    /** {@inheritDoc} */
    public int getEvictSynchronousTimeout() {
     ...
     */
    public void setEvictSyncTimeout(int evictSyncTimeout) {
