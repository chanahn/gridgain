...
public class GridTcpDiscoverySpi extends GridSpiAdapter implements GridDiscoverySpi, GridTcpDiscoverySpiMBean {
    ...
    public static final long DFLT_SOCK_TIMEOUT = 1000;
    ...
    /** {@inheritDoc} */
    @Override public long startTopologyVersion() {
        return startTopVer;
    }
    ...
    private class MessageWorker extends GridSpiThread {
        ...
        @Override protected void body() throws InterruptedException {
            while (!isInterrupted()) {
                GridTcpDiscoveryAbstractMessage msg = queue.poll(2000, MILLISECONDS);
                ...
                synchronized (mux) {
                    if (spiState == CONNECTING) {
                        if (topStore != null) {
                            ...
                            ring.restoreTopology(top, node.order());
