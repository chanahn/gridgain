...
GRIDGAIN_LIBS="${USER_LIBS}${SEPARATOR}${GRIDGAIN_HOME}"/libs/commons-jexl-2.1.1.jar
...
GRIDGAIN_LIBS="${GRIDGAIN_LIBS}${SEPARATOR}${GRIDGAIN_HOME}"/libs/javassist-3.12.1.jar
...
GRIDGAIN_LIBS="${GRIDGAIN_LIBS}${SEPARATOR}${GRIDGAIN_HOME}"/libs/activation-1.1.1.jar
...
GRIDGAIN_LIBS="${GRIDGAIN_LIBS}${SEPARATOR}${GRIDGAIN_HOME}"/libs/commons-httpclient-3.1.jar
