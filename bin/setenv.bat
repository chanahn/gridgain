...
set GRIDGAIN_LIBS=%USER_LIBS%;%GRIDGAIN_HOME%\libs\commons-jexl-2.1.1.jar
...
set GRIDGAIN_LIBS=%GRIDGAIN_LIBS%;%GRIDGAIN_HOME%\libs\javassist-3.12.1.jar
...
set GRIDGAIN_LIBS=%GRIDGAIN_LIBS%;%GRIDGAIN_HOME%\libs\activation-1.1.1.jar
...
set GRIDGAIN_LIBS=%GRIDGAIN_LIBS%;%GRIDGAIN_HOME%\libs\commons-httpclient-3.1.jar
