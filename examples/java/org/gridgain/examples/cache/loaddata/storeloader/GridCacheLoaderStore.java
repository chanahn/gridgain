 ...
 * The only implemented method is {@link #loadAll(String, GridInClosure2, Object...)}
 ...
 * this example. Take a look at examples defined in {@link org.gridgain.examples.cache.store}
...
public class GridCacheLoaderStore extends GridCacheStoreAdapter<String, Integer> {
    ...
    /** {@inheritDoc} */
    @Override public void loadAll(@Nullable String cacheName, final GridInClosure2<String, Integer> clo,
        ...
        for (int i = 0; i < entryCnt; i++) {
            ...
            if (cache.primaryOrBackup(grid.localNode(), key))
                clo.apply(key, i);
    ...
    /** {@inheritDoc} */
    @Override public Integer load(@Nullable String cacheName, @Nullable GridCacheTx tx, String key)
    ...
    /** {@inheritDoc} */
    @Override public void put(@Nullable String cacheName, @Nullable GridCacheTx tx, String key,
        @Nullable Integer val) throws GridException {
        assert false : "This method is never called in our example.";
    }

    /** {@inheritDoc} */
    @Override public void remove(@Nullable String cacheName, @Nullable GridCacheTx tx, String key)
        throws GridException {
        assert false : "This method is never called in our example.";
    }
}
