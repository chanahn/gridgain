...
/**
 * Starts up an empty node with Segment B configuration.
 * <p>
 ...
 * {@code 'ggstart.sh path/to/nodeB.xml'}.
 *
 * @author @java.author
 * @version @java.version
 */
public class GridNodeBStartup {
    /**
    ...
    public static void main(String[] args) throws GridException {
        AbstractApplicationContext ctx =
            new ClassPathXmlApplicationContext("org/gridgain/examples/multispi/nodeB.xml");
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                null,
                new JComponent[] {
                    new JLabel("Grid node for Segment B started."),
