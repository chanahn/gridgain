 ...
 * executed on remote grid node. The {@link GridifySpringHelloWorld} is
 ...
 * with Spring AOP refer to {@link org.gridgain.examples.aop.springaop.GridifySpringHelloWorldExample} example.
 *
 * @author @java.author
...
public final class GridifySpringHelloWorldExample {
    ...
    public static void main(String[] args) throws GridException {
        ...
        try {
            ...
            BeanFactory ctx = new ClassPathXmlApplicationContext("org/gridgain/examples/aop/spring/spring-bean.xml");

            // Get the Spring bean to grid-enable.
            GridifySpringHelloWorld bean = (GridifySpringHelloWorld)ctx.getBean("hello.world.bean");
