...
package org.gridgain.examples.continuation.fibonacci;
 ...
 * {@link GridJobContext#callcc()} method calls in {@link FibonacciClosure} class.
 * <p>
...
public final class GridFibonacciContinuationExample {
    ...
    public static void main(String[] args) throws GridException {
        ...
        G.in(args.length == 0 ? null : args[0], new CIX1<Grid>() {
            @Override public void applyx(final Grid g) throws GridException {
                ...
                BigInteger fib = g.call(UNICAST, new FibonacciClosure(nodeFilter), N, nodeFilter);
     ...
     * Closure to execute.
     */
    private static class FibonacciClosure extends GridClosureX<Long, BigInteger> {
         ...
         */
        FibonacciClosure(GridPredicate<GridRichNode> nodeFilter) {
        ...
        @Nullable @Override public BigInteger applyx(Long n) throws GridException {
            if (fut1 == null || fut2 == null) {
                ...
                if (fut1 == null)
                    fut1 = store.addIfAbsent(n - 1, g.callAsync(UNICAST, new FibonacciClosure(nodeFilter), n - 1, nodeFilter));

                // If future is not cached in node-local store, cache it.
                if (fut2 == null)
                    fut2 = store.addIfAbsent(n - 2, g.callAsync(UNICAST, new FibonacciClosure(nodeFilter), n - 2, nodeFilter));
