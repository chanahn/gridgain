## GridGain Examples
This folder contains all examples shipped with GridGain including examples for Java, Scala, Groovy, PHP with REST access as well as configuration and other miscelenious files.
...
This is the simple example of full featured MapReduce app in Grover (equivilant to Java example above):
